...
public class CPAMain {
  ...
  public static boolean useVariableSlice = true;
  ...
  public static void main(String[] args) {
    ...
    if(summaryInputPath != null) {
      ProgramInfo.getInstance().readOldFunctionInfo(summaryInputPath);
      isReuseSummary = true;
      System.out.println("load function info ok..................");
    }
  ...
  private static Pair<Configuration, String> createConfiguration(String[] args) throws InvalidConfigurationException, InvalidCmdlineArgumentException, IOException {
    ...
    if(cmdLineOptions.containsKey("noUseVariableSlice")) {
      useVariableSlice = false;
    }
    ...
    //added by CLM
    if(config.getProperty("CompositeCPA.cpas").contains("cpa.value.ValueAnalysisCPA")) {
      abstractType = AbstractType.VALUEANALYSIS;
    }
    else if(config.getProperty("CompositeCPA.cpas").contains("cpa.predicate.BAMPredicateCPA")) {
      abstractType = AbstractType.PREDICATEANALYSIS;
    }
    else {
      abstractType = AbstractType.VALUEANALYSIS;
    }
    if(config.hasProperty("cpa.predicate.predmap.export") || config.hasProperty("cpa.value.precisionFile")) {
      isReusePrecision = true;
    }
